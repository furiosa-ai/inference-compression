...
def get_args():
    ...
    parser.add_argument('--model_source',default='mlperf_submission',type=str,choices=['huggingface_rngd_gelu', 'mlperf_submission', 'experimental_huggingface_unsplit_packed'], help='choose model source',)
