...
class BERT_PyTorch_SUT:
    def __init__(self, args):
        ...
        elif self.model_source == 'compact_causal_mask':
            from furiosa_llm_models.bert.symbolic.experimental.huggingface_unsplit_packed import (
                BertForQuestionAnswering,
            )
    ...
    def process_sample(self, sample_input, query_id=None):
        ...
        with torch.no_grad():
            ...
            elif self.model_source == "mlperf_submission" or self.model_source == "compact_causal_mask":
                padded_sequences = {}
